...
if ($_SESSION["Userlevel"] == "A") {
    ...
    <?php include "./include/navbar.php"; ?>
                        ...
                        <tbody>
                            ...
                            while ($row = mysqli_fetch_array($result)) {
                                ...
                                <tr>
                                    ...
                                    <td><button class="btn btn-warning editpayment" data-toggle="modal" data-target="#editpayment" edit_id='<?php echo $row['tr_id']; ?>' user_id='<?php echo $row['user_id']; ?>'>แก้ไข</button></td>
                                    <!-- <td><button class="btn btn-danger delpayment" del_id='<?php echo $row['tr_id']; ?>' user_id='<?php echo $row['user_id']; ?>'>ลบ</button></td> -->
                                </tr>
                                <?php $count++;
                            } ?>
                        </tbody>
        ...
        <script>
            ...
            // edit_payment
            $("body").delegate(".editpayment", "click", function(event) {
                event.preventDefault();
                var edit = $(this).attr("edit_id");
                var user_id = $(this).attr("user_id");
                // alert(user_id);
                $.ajax({
                    url: "view_payment.php",
            ...
            //delpayment
            $("body").on(".delpayment", "click", function(events) {
                events.preventDefault();
                var del = $(this).attr("del_id");
                var user_id = $(this).attr("user_id");
                // alert(user_id);
                // alert(del);
                $.ajax({
