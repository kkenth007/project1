    ...
    <div class="collapse navbar-collapse" id="navb">
        ...
        <ul class="navbar-nav ml-auto">
            <li class="nav-item dropdown show myshow">
                <a class="nav-link dropdown" style="padding-right: 20px;" href="#" id="dropdown03" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true"><i class="fas fa-shopping-cart"></i> Cart <span class="badge badge-light">2</span></a>
                    ...
                    <div style="width:300px;padding: 16px;">
                        <div class="panel panel-success">
                            <div class="card-body">
                                ...
                                <div class="sub-total"><label class="text-uppercase">ราคารวม :</label><label class="all-price">$120.00</label></div>
