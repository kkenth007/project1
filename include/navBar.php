<nav class="navbar navbar-expand-lg navbar-dark" style="background-color:#007bff;">
                        ...
                        <div class="panel panel-primary">
                            ...
                            <form action="register.php" method="post">
                                <div class="panel-heading">
                                    ...
                                    <input type="text" class="form-control" id="name" name="fname" autocomplete="off" placeholder="กรอกชื่อของคุณ.." required>
                                    <label for="lname">นามสกุล</label>
                                    <input type="text" class="form-control" id="lname" name="lname" autocomplete="off" placeholder="กรอกนามของคุณ.." required>
                                    <div class="form-group">
                                        <label for="email">อีเมล์</label>
                                        <input type="email" class="form-control" id="email" name="email" autocomplete="off" placeholder="กรอกอีเมล์ของคุณ.." required>
                                        <span id="emailMsg"></span>
                                    </div>
                                    <div class="form-group">
                                        <label for="password">รหัสผ่าน</label>
                                        <input class="form-control" id="pass" name="password" name="password" placeholder="กรอกรหัสผ่าน.." required data-toggle="password">
                                        <div id="passMsg"></div>
                                    </div>
                                    ...
                                    <p><br /></p>
                                    <!-- <button class="btn btn-danger" data-toggle="modal" data-target="#resetPW">Reset Password</button> -->
                                    <a href="#" style="color:#e84118;list-style:none;" data-toggle="modal" data-target="#resetPW">Forgotten Password</a>
                                    
                                    <input type="submit" class="btn btn-primary" style="float:right;" id="btn" value="สมัครสมาชิก">
                            </form>
                        </div>
    ...
    <li class="nav-item dropdown show myshow">
        <a class="nav-link dropdown-toggle" style="padding-right: 20px;" href="#" id="dropdown03" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true"><i class="fas fa-user"></i>
            เข้าสู่ระบบ</a>
        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown03">
            <div style="width:320px;padding: 16px;">
                <div class="panel panel-primary">
                    ...
                    <form action="login.php" method="post">
                        <div class="panel-heading">
                            <label for="email">อีเมล์</label>
                            <input type="eamil" class="form-control" id="remail" name="username" placeholder="กรอกอีเมล์ของคุณ.." required>
                            <label for="password">รหัสผ่าน</label>
                            <input class="form-control" id="password" name="password" placeholder="กรอกรหัสผ่าน.." required data-toggle="password">
                            <p><br /></p>
                            <a href="#" style="color:#e84118;list-style:none;" data-toggle="modal" data-target="#resetPW">Forgotten Password</a>
