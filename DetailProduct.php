        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="card-columns" style="margin-top:20px;">
                    ...
                    <!-- fancy end -->
                    <div class="clearfixs"></div><br>
                    <div class="large-7 column">
                        <!-- .box-containt-2 -->
                        <div class="box-containt-2">

                            <h1>ที่เที่ยวภูเขา ที่เที่ยวหน้าหนาวที่ไหนดี</h1>
                            <p>
                                ที่เที่ยวภูเขา ที่เที่ยวหน้าหนาวที่ไหนดี รวม
                                สถานที่ท่องเที่ยวภูเขา อาทิ ภูทับเบิก เขาใหญ่ เขาค้อ ภูกระดึง ดอยอินทนนท์
                                พร้อมแนะนำที่เที่ยวหน้าหนาวยอดฮิตสวยๆ
                            </p>
